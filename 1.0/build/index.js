 ...
 * @module kheatmap
 **/
KISSY.add('gallery/kheatmap/1.0/index',function (S, Node, Base) {
	var EMPTY = '';
	var $ = Node.all;
	 ...
	 * @extends Base
	 */
	function KHeatMap(canvas, width, height) {
		var self = this;
		//调用父类构造函数
		KHeatMap.superclass.constructor.call(self, canvas, width, height);
		this.canvas = canvas;
		this.width = width;
		this.height = height;
		this._init();
	...
	S.extend(KHeatMap, Base, /** @lends KHeatMap.prototype*/{

	}, {ATTRS: /** @lends KHeatMap*/{
